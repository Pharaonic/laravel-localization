...
return [
    ...
    'list'         => [
        ...
        'ar'       => ['name' => 'Arabic', 'native' => 'العربية', 'rtl' => false],
        // 'ar_DZ'    => ['name' => 'Arabic (Algeria)', 'native' => 'العربية', 'rtl' => false],
        // 'ar_BH'    => ['name' => 'Arabic (Bahrain)', 'native' => 'العربية', 'rtl' => false],
        // 'ar_TD'    => ['name' => 'Arabic (Chad)', 'native' => 'العربية', 'rtl' => false],
        // 'ar_KM'    => ['name' => 'Arabic (Comoros)', 'native' => 'العربية', 'rtl' => false],
        // 'ar_DJ'    => ['name' => 'Arabic (Djibouti)', 'native' => 'العربية', 'rtl' => false],
        // 'ar_EG'    => ['name' => 'Arabic (Egypt)', 'native' => 'العربية', 'rtl' => false],
        // 'ar_ER'    => ['name' => 'Arabic (Eritrea)', 'native' => 'العربية', 'rtl' => false],
        // 'ar_IQ'    => ['name' => 'Arabic (Iraq)', 'native' => 'العربية', 'rtl' => false],
        // 'ar_IL'    => ['name' => 'Arabic (Israel)', 'native' => 'العربية', 'rtl' => false],
        // 'ar_JO'    => ['name' => 'Arabic (Jordan)', 'native' => 'العربية', 'rtl' => false],
        // 'ar_KW'    => ['name' => 'Arabic (Kuwait)', 'native' => 'العربية', 'rtl' => false],
        // 'ar_LB'    => ['name' => 'Arabic (Lebanon)', 'native' => 'العربية', 'rtl' => false],
        // 'ar_LY'    => ['name' => 'Arabic (Libya)', 'native' => 'العربية', 'rtl' => false],
        // 'ar_MR'    => ['name' => 'Arabic (Mauritania)', 'native' => 'العربية', 'rtl' => false],
        // 'ar_MA'    => ['name' => 'Arabic (Morocco)', 'native' => 'العربية', 'rtl' => false],
        // 'ar_OM'    => ['name' => 'Arabic (Oman)', 'native' => 'العربية', 'rtl' => false],
        // 'ar_PS'    => ['name' => 'Arabic (Palestinian Territories)', 'native' => 'العربية', 'rtl' => false],
        // 'ar_QA'    => ['name' => 'Arabic (Qatar)', 'native' => 'العربية', 'rtl' => false],
        // 'ar_SA'    => ['name' => 'Arabic (Saudi Arabia)', 'native' => 'العربية', 'rtl' => false],
        // 'ar_SO'    => ['name' => 'Arabic (Somalia)', 'native' => 'العربية', 'rtl' => false],
        // 'ar_SS'    => ['name' => 'Arabic (South Sudan)', 'native' => 'العربية', 'rtl' => false],
        // 'ar_SD'    => ['name' => 'Arabic (Sudan)', 'native' => 'العربية', 'rtl' => false],
        // 'ar_SY'    => ['name' => 'Arabic (Syria)', 'native' => 'العربية', 'rtl' => false],
        // 'ar_TN'    => ['name' => 'Arabic (Tunisia)', 'native' => 'العربية', 'rtl' => false],
        // 'ar_AE'    => ['name' => 'Arabic (United Arab Emirates)', 'native' => 'العربية', 'rtl' => false],
        // 'ar_EH'    => ['name' => 'Arabic (Western Sahara)', 'native' => 'العربية', 'rtl' => false],
        // 'ar_YE'    => ['name' => 'Arabic (Yemen)', 'native' => 'العربية', 'rtl' => false],
        ...
        // 'ha_GH'    => ['name' => 'Hausa (Ghana)', 'native' => 'Hausa', 'rtl' => false],
        // 'ha_Latn'  => ['name' => 'Hausa (Latin)', 'native' => 'Hausa', 'rtl' => false],
        // 'ha_NE'    => ['name' => 'Hausa (Niger)', 'native' => 'Hausa', 'rtl' => false],
        // 'ha_NG'    => ['name' => 'Hausa (Nigeria)', 'native' => 'Hausa', 'rtl' => false],
        // 'he'       => ['name' => 'Hebrew', 'native' => 'עברית', 'rtl' => false],
        // 'he_IL'    => ['name' => 'Hebrew (Israel)', 'native' => 'עברית', 'rtl' => false],
        ...
        // 'ks'       => ['name' => 'Kashmiri', 'native' => 'کٲشُر', 'rtl' => false],
        // 'ks_Arab'  => ['name' => 'Kashmiri (Arabic)', 'native' => 'کٲشُر', 'rtl' => false],
        // 'ks_IN'    => ['name' => 'Kashmiri (India)', 'native' => 'کٲشُر', 'rtl' => false],
        ...
        // 'ps'       => ['name' => 'Pashto', 'native' => 'پښتو', 'rtl' => false],
        // 'ps_AF'    => ['name' => 'Pashto (Afghanistan)', 'native' => 'پښتو', 'rtl' => false],
        // 'fa'       => ['name' => 'Persian', 'native' => 'فارسی', 'rtl' => false],
        // 'fa_AF'    => ['name' => 'Persian (Afghanistan)', 'native' => 'فارسی', 'rtl' => false],
        // 'fa_IR'    => ['name' => 'Persian (Iran)', 'native' => 'فارسی', 'rtl' => false],
        ...
        'ur'       => ['name' => 'Urdu', 'native' => 'اردو', 'rtl' => false],
        // 'ur_IN'    => ['name' => 'Urdu (India)', 'native' => 'اردو', 'rtl' => false],
        // 'ur_PK'    => ['name' => 'Urdu (Pakistan)', 'native' => 'اردو', 'rtl' => false],
        ...
        // 'uz_AF'    => ['name' => 'Uzbek (Afghanistan)', 'native' => 'oʻzbekcha', 'rtl' => false],
        // 'uz_Arab'  => ['name' => 'Uzbek (Arabic)', 'native' => 'اوزبیک', 'rtl' => false],
        // 'uz_Cyrl'  => ['name' => 'Uzbek (Cyrillic)', 'native' => 'Ўзбек', 'rtl' => false],
        // 'uz_UZ'    => ['name' => 'Uzbek (Uzbekistan)', 'native' => 'oʻzbekcha', 'rtl' => false],
        ...
        // 'yi'       => ['name' => 'Yiddish', 'native' => 'ייִדיש', 'rtl' => false],
